...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.menubar.add_command(
                label="Каталог товаров", command=korzina_support.opening1)
        ...
        self.sub_menu.add_command(
                label="Мои заказы", command=korzina_support.opening2)
        ...
        self.sub_menu1.add_command(
                label="О программе", command=korzina_support.opening3)
        self.sub_menu1.add_command(
                label="Разработчики", command=korzina_support.opening4)
        ...
        self.Button1.configure(text='''ОФОРМИТЬ ЗАКАЗ''', command=korzina_support.opening2)
        ...
        self.Button2.configure(text='''Удалить''', command=korzina_support.delete1)
        ...
        self.Button2_1.configure(text='''Удалить''', command=korzina_support.delete2)


def start_up():
    korzina_support.main()
